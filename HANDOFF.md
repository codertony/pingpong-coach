...
| 几何/滤波/切分/特征/规则/准备区标定/手部几何 | motion-core 171 项测试 |
...
> 🔴 **最重要的一句话**：
> 测试从 172 涨到 449（395 单元 + 54 e2e），但**增量几乎全部落在"代码正确性"上**。
...
| ❌ 声称"测试全绿所以识别准确" | 449 项测试（395 单元 + 54 e2e）里没有一项验证识别准确率 |
...
> 代码骨架完整，工程护栏齐备，**395 项单元测试 + 54 项浏览器测试全部通过**。
