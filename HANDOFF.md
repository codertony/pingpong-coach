...
| 几何/滤波/切分/特征/规则/准备区标定/手部几何 | motion-core 199 项测试 |
...
> 🔴 **最重要的一句话**：
> 测试从 172 涨到 504（439 单元 + 65 e2e），但**增量几乎全部落在"代码正确性"上**。
...
| ❌ 声称"测试全绿所以识别准确" | 504 项测试（439 单元 + 65 e2e）里没有一项验证识别准确率 |
...
> 代码骨架完整，工程护栏齐备，**439 项单元测试 + 65 项浏览器测试全部通过**。
